 ...
 */
public class Daemon implements UncaughtExceptionHandler {
    ...
    public static void main(String... args) throws Exception {
        ...
        Thread.setDefaultUncaughtExceptionHandler(new Daemon());
    ...
    static ClassLoader getClassLoader() {
        ...
        return classLoader != null ? classLoader : Daemon.class.getClassLoader();
    }
