...
public class MXBeanTest {
    ...
    public void testRegister() throws Exception {
        ...
        final ObjectInstance objectInstance = server.registerMBean(new SomeMXBeanImpl(), objectName);
        try {
            final SomeMXBean bean = JMX.newMXBeanProxy(server, objectName, SomeMXBean.class);
    ...
    public static class SomeMXBeanImpl implements SomeMXBean {
        @Override
        public Data getData() {
