...
CREATE SCHEMA NUMERICS AUTHORIZATION DBA;
SET INITIAL SCHEMA NUMERICS;
SET SCHEMA NUMERICS;
...
CREATE CACHED TABLE NUMERICS(TAG BIGINT, TS TIMESTAMP, VAL DOUBLE, CONSTRAINT PK_NUMERICS PRIMARY KEY(TAG, TS));
