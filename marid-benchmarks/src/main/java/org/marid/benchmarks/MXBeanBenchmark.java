...
public class MXBeanBenchmark {

    private static final int COUNT = 10_000;

    private static final Impl DIRECT = new Impl();
    private static final Some JMX_BEAN;
    ...
    static {
        try {
            ...
            JMX_BEAN = newMXBeanProxy(CONNECTION, OBJECT_NAME, Some.class);
        } catch (Exception x) {
    ...
    public static class Impl implements Some {
